defmodule ReceptGeneratornWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ReceptGeneratornWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/recept_generatorn_web/templates",
        namespace: ReceptGeneratornWeb
